 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = sagenes*48*4.445/100+arshins*16*4.45/100+vershoks*4.445/100
/**
 * Тривиальная
 *
 ...
 */
fun thirdDigit(number: Int): Int {var p=number/100
    var o=p%10
    return o
}
...
fun numberRevert(number: Int): Int  {
    val i = (number / 100)
    val w = (number - i * 100) / 10
    val q = (number - 10 * w - i * 100)
    return 100 * q + 10 * w + i
}
